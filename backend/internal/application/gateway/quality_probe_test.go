...
func TestQualityProbeTotalTokensPerSecondUsesWholeRequestWindow(t *testing.T) {
	got := qualityProbeTokensPerSecond(1335, 17320)
...
func TestQualityProbeVisibleTokensPerSecondExcludesReasoningTokens(t *testing.T) {
	got := qualityProbeTokensPerSecond(100, 100)
	if got != 1000 {
		t.Fatalf("visible TPS = %v, want 1000", got)
	}
}
